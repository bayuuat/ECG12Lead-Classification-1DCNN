...
i = 1
for filename in os.listdir(pathNormal):
    if i <= 200:
        shutil.copyfile(os.path.join(pathNormal, filename),
                        os.path.join(newDatasetPathTrain, 'NOR'+str(i)+'.txt'))
        ...
        shutil.copyfile(os.path.join(pathNormal, filename),
                        os.path.join(newDatasetPathTest, 'NOR'+str(i-200)+'.txt'))
